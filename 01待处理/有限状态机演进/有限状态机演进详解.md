...
> **前置基础**：本文默认读者已掌握 [[有限状态机基础入门#3. 从 C 语言语法到状态机：必要的工具箱|C 语言工具箱]] 中枚举、函数指针、struct、回调的基础用法
...
- [[有限状态机基础入门#3. 从 C 语言语法到状态机：必要的工具箱|C 语言工具箱]] — 枚举/函数指针/struct/回调的 FSM 应用
- [[有限状态机基础入门#5. 状态机的心跳|心跳机制]] — 心跳的定义与驱动方式
- [[有限状态机基础入门#6. 状态切换流程的详细设计|状态切换流程]] — 切换步骤与时序分析
- [[驱动层状态机实操指南#1. 核心思想：时序图 → 状态图|驱动层状态机]] — 时序图→状态图,中断解耦,超时保护
- [[应用层状态机实操指南#1. 核心思想：业务流程 → 状态图|应用层状态机]] — 业务流程→状态图,ENTRY/EXIT,多机协作
