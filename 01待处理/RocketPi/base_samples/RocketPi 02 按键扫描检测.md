...
> 代码来源：`Embedded_Code/01待处理/rocketpi/base_samples/02_rocketpi_key_scan/main.c`
> 硬件：STM32F401RE（RocketPi 开发板），PA0 按键，LED_B/LED_G/LED_P 三个 LED

## 实验目标

在主循环中轮询按键电平，实现两种基础按键响应模型，并用 `#if 0 / #else` 切换编译：
...
- [[RocketPi 01 LED 点灯|GPIO 输出基础]] — 本篇的按键检测建立在 LED 输出之上
- [[RocketPi 03 按键中断|EXTI 中断按键]] — 解决本篇"死等松手"阻塞问题

## 代码仓库链接

- [main.c](https://github.com/FuYunLi/Embedded_Code/blob/master/01待处理/rocketpi/base_samples/02_rocketpi_key_scan/main.c)
